...
* 기간
  * 2021.01 ~ 2021.06
* 역할
  * **Android 에 Pose Detection 인공지능 적용** <br/><br/> Android 개발을 진행하면서 인공지능 기술을 사용해보고 싶었지만 이전에는 정형화된 API 사용만 해보았습니다. 이번에는 내가 원하는대로 가공할 수 있는 인공지능 앱을 개발하고 싶었습니다. <br/><br/> 졸업작품 프로젝트를 계기로 Google MediaPipe Pose 인공지능을 안드로이드에 적용해보았습니다. 운동 자세인식을 위해 UP, DOWN 포즈를 학습시키고 CSV 좌표 파일을 안드로이드에서 활용해 사용자의 자세를 인식하는 기능을 구현하였습니다.
...
* **2021-1학기 캡스톤디자인 경진대회 [대상]**
  * 수상년월 2021.06
  * 발행기관 : 대구대학교 LINC+사업단

* **DU-Dream 창업아이디어 경진대회 [대상]**
  * 수상년월 2021.06
  * 발행기관 : 대구대학교 창업지원단
